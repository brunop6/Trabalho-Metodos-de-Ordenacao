...
string vet1[V1LEN], vet5[V5LEN], vet10[V10LEN], vet15[V15LEN], vet20[V20LEN], vet30[V30LEN], vet40[V40LEN];
...
int main() {
  ...
  */ 
  ...
  int iniTime, endTime;
  //Tempos bubble sort
  int bubbleT1, bubbleT5, bubbleT10, bubbleT15, bubbleT20, bubbleT30, bubbleT40;
  //Tempos selection sort
  int selectionT1, selectionT5, selectionT10, selectionT15, selectionT20, selectionT30, selectionT40;
  //Tempos insertion sort
  int insertionT1, insertionT5, insertionT10, insertionT15, insertionT20, insertionT30, insertionT40;
  //Tempos shell sort
  int shellT1, shellT5, shellT10, shellT15, shellT20, shellT30, shellT40;
//Tempos merge sort
  int mergeT1, mergeT5, mergeT10, mergeT15, mergeT20, mergeT30, mergeT40;
  //Tempos quick sort
  int quickT1, quickT5, quickT10, quickT15, quickT20, quickT30, quickT40;

  //Valida a criação dos vetores com os valores do arquivo p/ prosseguir
  if(createArrays()){
    cout << "Executando ordenacoes...\n"<<endl;
    ...
    cout << "\nTabela Final\nn    \tBubble \t\tSelection \tInsertion \tShell \t\tMerge \t\tQuick" << endl;
